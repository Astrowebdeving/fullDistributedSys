...
def handle_f2_message(data):
    ...
    if message.startswith("F2"):
        ...
        with open(f"error_time3_{server_current_self_name}_{repetition_index}.txt", 'w') as f:
            f.write(str(curr_client_time))

        os.system(f"touch error_time3_{prev_server_self_name}_{repetition_index}_i.txt")
        with open(f"error_time3_{prev_server_self_name}_{repetition_index}_i.txt", 'w') as f:
            f.write(str(time_on_reception))
        
        os.system(f"touch error_time3_{prev_server_self_name}_{repetition_index}_f.txt")
        with open(f"error_time3_{prev_server_self_name}_{repetition_index}_f.txt", 'w') as f:
        ...
        if repetition_index == 1:
            ...
            os.system(f"sudo ./time_setting_ns {final_error_time}")
...
if __name__ == "__main__":
    ...
    if message.startswith("H2"):
        ...
        stop_threads = False 
        # Start listening for E1 and F2 messages
